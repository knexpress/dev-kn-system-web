...
export const PLACEHOLDER_ACCOUNTS: AccountPreview[] = [
  ...
  { code: '1100', name: 'Accounts Receivable', type: 'Asset', subtype: 'Current Asset', active: true },
  { code: '1200', name: 'Inventory', type: 'Asset', subtype: 'Current Asset', active: true },
  { code: '1300', name: 'VAT Input', type: 'Asset', subtype: 'Current Asset', active: true },
  { code: '2000', name: 'Accounts Payable', type: 'Liability', subtype: 'Current Liability', active: true },
  { code: '2100', name: 'VAT Output', type: 'Liability', subtype: 'Current Liability', active: true },
  { code: '3000', name: 'Owner Equity', type: 'Equity', subtype: 'Equity', active: true },
  { code: '4000', name: 'Freight Revenue', type: 'Revenue', subtype: 'Operating Revenue', active: true },
